...
class ScriptStepDialog(QDialog):
    ...
    def __init__(
        ...
        self._label_edit.setToolTip(
            self.tr("Nombre descriptivo del paso, aparece en la lista del pipeline")
        )
        ...
        self._entry_edit.setToolTip(
            self.tr("Nombre de la función Python que se ejecutará en cada página")
        )
        ...
        help_label = QLabel(QCoreApplication.translate("ScriptStepDialog", _HELP_TEXT))
