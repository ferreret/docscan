...
<template>
  <div v-if="appStore.current">
    ...
    <div
      class="bg-base rounded-md border border-surface-0 p-6 max-w-2xl space-y-6"
          ...
          <div data-test="section-csv-fields">
            ...
            <div class="flex gap-2">
              ...
              <button
                ...
                @click="addCsvField"
                class="text-[13px] bg-primary text-base rounded px-3 py-1.5 font-medium hover:bg-primary-hover"
              >
                Añadir
              </button>
            </div>
