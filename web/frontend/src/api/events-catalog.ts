...
const TRANSFER_RESULT_VAR: ContextVariable = {
  ...
  members: [
    {
      name: "success",
      description: "bool — True si la transferencia fue correcta.",
    },
    {
      name: "errors",
      description: "list[str] — Errores producidos durante la transferencia.",
    },
    {
      name: "output_path",
      description: "str — Ruta del fichero o directorio de salida.",
    },
  ],
};
...
const TRANSFER_PAGE_RESULT_VAR: ContextVariable = {
  ...
  members: [
    {
      name: "output_path",
      description: "str — Ruta del fichero generado para esta página.",
    },
    {
      name: "success",
      description: "bool — True si la página se transfirió correctamente.",
    },
    {
      name: "error",
      description: "str | None — Mensaje de error si la página falló.",
    },
  ],
};
...
const PAGE_VAR: ContextVariable = CONTEXT_VARIABLES.find(
  (v) => v.name === "page",
)!;
...
`,
  ...
  },
  {
    ...
    description:
      "Se ejecuta antes de la transferencia. Retorna False para abortar.",
...
`,
  ...
  },
  {
    ...
    description:
      "Se dispara al abrir el lote en el workbench. Retornar {cancel: true} impide la carga.",
  ...
  },
  {
    ...
    description:
      "Antes de navegar a la página anterior. Retornar {cancel: true} o {target_page_id: N}.",
  ...
  },
  {
    ...
    description:
      "Antes de navegar a la página siguiente. Retornar {cancel: true} o {target_page_id: N}.",
  ...
  },
  {
    ...
    description:
      "Tras cambiar a una página. Fire-and-forget. Puede mutar page.fields para actualizar la UI.",
